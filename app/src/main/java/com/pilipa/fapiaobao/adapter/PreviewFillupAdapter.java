...
public class PreviewFillupAdapter extends FragmentPagerAdapter {
    private static final String TAG = "PreviewPagerAdapter";
    public ArrayList<PreviewFillupFragment> arrayList;
    public PreviewFillupAdapter(FragmentManager fm, ArrayList<PreviewFillupFragment> fragmentList) {
        super(fm);
