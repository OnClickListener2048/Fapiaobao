package com.pilipa.fapiaobao.databinding.widget;
...
//        }
        if (getBackground() != null) {
            getBackground().setColorFilter(getResources().getColor(com.pilipa.fapiaobao.R.color.filter), PorterDuff.Mode.MULTIPLY);
        }
        invalidate();
    }
