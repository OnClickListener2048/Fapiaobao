...
//    }
     ...
     * @param view
     */
    private void initDialog(View view, final TimePickerDialogInterface timePickerDialogInterface) {
...
//    }
     ...
     * 显示日期选择器
     */
    public void showDatePickerDialog(TimePickerDialogInterface timePickerDialogInterface) {
        mTag=1;
        View view = initDatePicker();
        mAlertDialog = new AlertDialog.Builder(mContext);
        mAlertDialog.setTitle("选择时间");
        initDialog(view,timePickerDialogInterface);
        mAlertDialog.show();
    }
    /**
     * 显示日期选择器
