...
//            , R.id.tv_area, R.id.iv_select_area
    ...
    private void createPopup() {
        mPreviewPopup = new PreviewPopup.PopupBuilder(this)
                ...
                .setDemandAmount(getTextViewValue(etAmount))
                .setBonus(Switch.isChecked() ? getTextViewValue(etAmountRedbag) : "")
                .setAvailableBalance(String.valueOf(AccountHelper.getUser().getData().getCustomer().getAvailiableBalance()))
