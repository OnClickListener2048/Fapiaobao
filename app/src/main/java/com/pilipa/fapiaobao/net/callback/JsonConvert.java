...
import com.pilipa.fapiaobao.net.bean.base.SimpleResponse;
import com.pilipa.fapiaobao.utils.Convert;
    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != BaseResponseBean.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                BaseResponseBean baseResponseBean = Convert.fromJson(jsonReader, type);
                response.close();
                int code = baseResponseBean.getStatus();
                if (code == Constant.REQUEST_SUCCESS) {
